...
Route::get('/categorie/modifier', [CategorieController::class, 'modifier'])->name('admin.categorie.modifier');
...
Route::get('/oeuvre/modifier', [OeuvreController::class, 'modifier'])->name('admin.oeuvre.modifier');
