        ...
        <form method="POST" action="{{ route('admin.oeuvre.modifier'), $oeuvre->id }}" enctype="multipart/form-data">
            ...
            <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="image" name="artiste" value="{{ old('artiste', $article->artiste) }}" required>
                    @error('artiste')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="annee_fabrication" name="annee_fabrication" value="{{ old('annee_fabrication', $article->annee_fabrication) }}" required>
            ...
            <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="date_acquisition" name="date_acquisition" value="{{ old('date_acqusition', $article->date_acquisition) }}" required>
            ...
            <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="prix" name="prix" value="{{ old('prix', $article->prix) }}" required>
                    @error('prix')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                <div class="col-12">
                    ...
                    <input type="file" class="form-control" id="photo" name="photo" value="{{ old('photo', $article->photo) }}" required>
                    @error('photo')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
